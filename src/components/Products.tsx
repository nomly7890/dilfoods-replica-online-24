...
const Products = () => {
  return (
    <section className="py-16 bg-dil-yellow/20" id="products">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-dil-red mb-4">
            Our Product Categories
          </h2>
          <p className="text-xl text-dil-orange max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {categories.map((category, index) => (
            <div 
              key={index} 
              className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300 group border border-dil-red/10"
            >
              <div className="relative h-48 overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-dil-red/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-semibold text-dil-darkblue mb-2 group-hover:text-dil-red transition-colors">
                  {category.name}
                </h3>
                <p className="text-dil-orange/80">
                  {category.description}
                </p>
                <button className="mt-4 text-dil-red font-medium flex items-center group-hover:text-dil-orange transition-colors">
                  View Products 
